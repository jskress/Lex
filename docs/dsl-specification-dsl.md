...
of the clause twice.  The first time, the clause should be defined empty.  The second
time should contain the full definition.  When the DSL factory finds this situation, it
takes the second declaration as a continuation of the first.  **Note:** use such clauses
with care as the grammar can become problematic.
